  ...
  <div class="card-course">
    @forelse($events as $event)
        <a href="{{ route('trainer.events.show', $event->id) }}" class="card-item">
          <div class="card-media">
            ...
            @else
                <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400&h=300&fit=crop" alt="Default Image" class="card-image" />
            @endif
    ...
    @empty
      <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; background: #fff; border-radius: 16px;">
        <h4 style="color: #475569; font-weight: 600;">Belum ada jadwal Event</h4>
        <p style="color: #94a3b8; font-size: 14px;">Saat ini Anda belum ditugaskan untuk mengisi event apapun.</p>
      </div>
    @endforelse
  </div>

...
@section('content')
    ...
    <div class="card-course">
        @forelse($courses as $course)
            <a href="{{ route('trainer.detail-course', $course->id) }}" class="card-item">
                <div class="card-media">
                    <p class="badge-online">{{ strtoupper($course->level ?? 'General') }} TIER</p>

                    @if($course->card_thumbnail)
                        <img src="{{ asset('storage/' . $course->card_thumbnail) }}" alt="{{ $course->name }}" class="card-image" />
                    @else
                        <div class="card-image d-flex align-items-center justify-content-center bg-light text-muted">
                    ...
                    <div class="bottom-card">
                        <div class="total-participant-path">
                            ...
                            <div class="total-path">
                                ...
                                <p>{{ $course->modules_count }} UNITS</p>
                            </div>
                        </div>
        ...
        @empty
            <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: #666;">
                <p>Belum ada kelas yang ditugaskan kepada Anda.</p>
            </div>
        @endforelse
    </div>

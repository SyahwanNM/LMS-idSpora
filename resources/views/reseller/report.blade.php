...
<head>
    ...
    <style>
        ...
        /* WARNA KUNING DIUBAH DI SINI (#FFC107) */
    ...
    <div class="invoice-box">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color: #666;">{{ $item->event->title ?? $item->course->title ?? $item->description ?? 'Pembelian Event/Course' }}</td>
        ...
        <div class="summary">
            ...
            <div class="summary-row summary-total">
                <div class="summary-label">TOTAL CUAN (PAID)</div>

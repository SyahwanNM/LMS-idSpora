    ...
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="d-flex align-items-center gap-2 mb-0">
                ...
                <span>Withdraw Komisi</span>
            </h5>

            <!-- Small Notification -->
            <span class="badge bg-warning bg-opacity-10 text-warning rounded-pill px-3 py-2">
                <i class="bi bi-clock-history me-1"></i>
                1 komisi menunggu verifikasi
            </span>
        </div>
...
<div class="card mb-4 border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h5 class="fw-semibold mb-1">Riwayat Komisi</h5>
                <small class="text-muted">Pantau status komisi referral Anda</small>
            </div>
        ...
        <!-- TABLE STATE (ADA DATA) -->
        <div class="table-responsive">
            <table class="table align-middle text-center table-hover">
                <thead>
                    <tr>
                        <th class="small fw-semibold">Tanggal</th>
                        <th class="small fw-semibold">Pembeli</th>
                        <th class="small fw-semibold">Produk</th>
                        <th class="small fw-semibold">Total</th>
                        <th class="small fw-semibold">Komisi</th>
        ...
        <div class="text-center py-5">
            ...
            <h6 class="fw-semibold">Belum ada komisi</h6>
            <p class="text-muted mb-3">
                Bagikan referral link kamu untuk mulai mendapatkan komisi 🎉
            </p>
            <a href="#referral-tools" class="btn btn-outline-warning rounded-pill px-4">
                Lihat Referral Tools
            </a>
        </div>
        -->

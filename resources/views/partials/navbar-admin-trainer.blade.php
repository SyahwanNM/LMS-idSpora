<nav class="navbar navbar-expand-lg border-bottom sticky-top shadow-sm" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(15px); z-index: 1050; height: 72px;">
    <div class="container-fluid px-4">
        
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('admin.trainer.index') }}">
            <div class="rounded-3 d-flex align-items-center justify-content-center shadow-sm" style="width: 36px; height: 36px; background: linear-gradient(135deg, #3949ab 0%, #5c6bc0 100%);">
                <i class="bi bi-person-badge-fill text-white fs-5"></i>
            </div>
            <div class="d-flex flex-column justify-content-center" style="line-height: 1;">
                <span class="fw-800 text-dark tracking-tight" style="font-size: 1.1rem; font-family: 'Plus Jakarta Sans', sans-serif;">
                    TRAINER<span class="text-indigo">HUB</span>
                </span>
                <span class="text-muted" style="font-size: 0.65rem; letter-spacing: 1px; text-transform: uppercase;">Admin Portal</span>
            </div>
        </a>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2 mt-2" style="min-width: 240px;">
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item rounded-3 py-2 d-flex align-items-center" href="{{ route('admin.dashboard') }}">
                    ...
                    <li>
                        <a class="dropdown-item rounded-3 py-2 d-flex align-items-center" href="{{ route('admin.trainer.index') }}">
                            <div class="bg-light rounded p-1 me-2"><i class="bi bi-list-ul text-indigo"></i></div>
                            List Semua Trainer
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item rounded-3 py-2 d-flex align-items-center" href="{{ route('admin.trainer.create') }}">
                            <div class="bg-light rounded p-1 me-2"><i class="bi bi-person-plus-fill text-success"></i></div>
                            Tambah Trainer Baru
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item rounded-3 py-2 d-flex align-items-center" href="{{ route('admin.material.approvals') }}">
                            <div class="bg-light rounded p-1 me-2"><i class="bi bi-clipboard-check-fill text-warning"></i></div>
                            Material Approval
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="dropdown-item text-danger rounded-3 py-2 fw-semibold d-flex align-items-center">
                                <div class="bg-danger bg-opacity-10 rounded p-1 me-2"><i class="bi bi-box-arrow-right text-danger"></i></div>
                                Sign Out
                            </button>
                        </form>
                    </li>

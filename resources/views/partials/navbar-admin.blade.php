...
@media (max-width: 991.98px) {
    /* Container navbar lebih rapat di mobile */
    .navbar .container {
        padding-left: 12px;
        padding-right: 12px;
    }

    /* Area collapse jadi seperti card */
    .navbar-collapse {
    ...
    /* Dropdown profile tidak absolute di mobile */
    .profile-dropdown {

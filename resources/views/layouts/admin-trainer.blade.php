...
<style>
    ...
    @media (max-width: 991.98px) {
        ...
        .admin-trainer-main {
            padding: 20px;
            padding-top: calc(20px + 72px); /* mobile: keep space for navbar */
            width: 100%;
        }
...
@section('content')
    <div class="admin-trainer-wrapper">
        ...
        <main class="admin-trainer-main">
            <button class="btn btn-primary admin-sidebar-toggle d-lg-none mb-3"
                    type="button"
                    data-bs-toggle="offcanvas"
                    data-bs-target="#adminTrainerSidebarMobile"
                    aria-controls="adminTrainerSidebarMobile">

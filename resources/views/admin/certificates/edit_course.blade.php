                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="existingSigs" class="d-flex flex-wrap gap-2">
                                @php $sigs = is_array($course->certificate_signature) ? $course->certificate_signature : ($course->certificate_signature ? [$course->certificate_signature] : []); @endphp
                                @foreach($sigs as $sig)
        ...
        <div class="col-lg-4">
            <div class="card-minimal h-100 p-4">
                ...
                <div class="d-flex align-items-start mb-3">
                    ...
                    <div class="smaller text-muted">
                        <b>Partner Logo:</b> Digunakan jika kursus bekerja sama dengan instansi lain. Max 3 logo tambahan.
                    </div>
                </div>

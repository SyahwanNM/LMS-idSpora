...
<div class="crm-page-header d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    <div>
        ...
        <h1 style="font-size:1.5rem;font-weight:800;color:var(--crm-navy);letter-spacing:-0.8px;margin:0;">Konfigurasi Sertifikat</h1>
            ...
            <div class="card-minimal p-4 mb-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <p style="font-size:0.7rem;color:var(--crm-text-subtle);margin-top:10px;"><i class="bi bi-info-circle me-1"></i>Gunakan logo resolusi tinggi (PNG/SVG) untuk hasil cetak terbaik.</p>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card-minimal p-4 mb-3" style="background:var(--crm-accent-light);border:1px solid rgba(124,58,237,0.12);">
                ...
                <div class="d-flex gap-3 mb-3">
                    ...
                    <div style="font-size:0.75rem;color:var(--crm-navy-soft);line-height:1.5;"><b>Ukuran:</b> Maksimal 2MB per file untuk menjaga performa.</div>
                </div>
                <div class="d-flex gap-3 mb-3">
                ...
                <div class="d-flex gap-3">
                    <div style="width:30px;height:30px;border-radius:8px;background:#fff;color:#059669;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:var(--crm-shadow-sm);"><i class="bi bi-magic"></i></div>
                    <div style="font-size:0.75rem;color:var(--crm-navy-soft);line-height:1.5;"><b>Rekomendasi:</b> Gunakan background transparan (PNG) untuk TTD.</div>
                </div>
            </div>
            <div style="background:rgba(245,158,11,0.05);border:1px solid rgba(245,158,11,0.2);border-radius:12px;padding:1rem;font-size:0.75rem;color:#d97706;line-height:1.5;">

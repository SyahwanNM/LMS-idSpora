...
<div class="max-w-3xl mx-auto py-10 px-4">
    ...
    <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-6 bg-white rounded-xl shadow p-6 border border-gray-200">
        ...
        <div>
            ...
            <textarea name="bio" rows="3" class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500" placeholder="Ceritakan sedikit tentang Anda...">{{ old('bio', $user->bio) }}</textarea>
        </div>

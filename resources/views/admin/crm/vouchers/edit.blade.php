    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="font-size:0.75rem;margin-bottom:8px;">
                ...
                <li class="breadcrumb-item active" style="color:var(--crm-navy);font-weight:700;">Ubah</li>
            </ol>
        </nav>
        <h1 style="font-size:1.5rem;font-weight:800;color:var(--crm-navy);letter-spacing:-0.8px;margin:0;">Ubah Voucher</h1>
    </div>
...
<form method="POST" action="{{ route('admin.crm.vouchers.update', $voucher) }}">
    @csrf
    @method('PUT')
            ...
            <div class="card-minimal p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-field" id="code" name="code" value="{{ old('code', $voucher->code) }}" placeholder="Contoh: CASHBACK10" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-field" id="name" name="name" value="{{ old('name', $voucher->name) }}" placeholder="Contoh: Voucher Diskon 10%" required>
                    </div>

                    <div class="col-12">
                        <label for="description" class="form-field-label">Deskripsi</label>
                        <textarea class="form-field" id="description" name="description" rows="3" placeholder="Jelaskan mengenai kegunaan voucher ini...">{{ old('description', $voucher->description) }}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-field" style="cursor:pointer;" id="discount_type" name="discount_type" required>
                            <option value="fixed" {{ old('discount_type', $voucher->discount_type) == 'fixed' ? 'selected' : '' }}>Nominal Tetap (Rupiah)</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-field" id="discount_value" name="discount_value" value="{{ old('discount_value', $voucher->discount_value) }}" min="1" placeholder="Contoh: 50000 atau 10" required>
                    </div>

                    <div class="col-md-6">
                        <label for="points_required" class="form-field-label">Poin Yang Dibutuhkan <span class="text-danger">*</span></label>
                        <input type="number" class="form-field" id="points_required" name="points_required" value="{{ old('points_required', $voucher->points_required) }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-field" id="min_purchase" name="min_purchase" value="{{ old('min_purchase', $voucher->min_purchase) }}" min="0" required>
                    </div>

                    <div class="col-md-6">
                        <label for="expires_at" class="form-field-label">Tanggal Kedaluwarsa Voucher Master</label>
                        <input type="datetime-local" class="form-field" id="expires_at" name="expires_at" value="{{ old('expires_at', $voucher->expires_at ? $voucher->expires_at->format('Y-m-d\TH:i') : '') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-field" id="usage_limit" name="usage_limit" value="{{ old('usage_limit', $voucher->usage_limit) }}" min="1" placeholder="Contoh: 100">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-field" style="cursor:pointer;" id="active" name="active" required>
                            <option value="1" {{ old('active', $voucher->active ? '1' : '0') == '1' ? 'selected' : '' }}>Aktif (Tampilkan untuk Pelanggan)</option>
                            <option value="0" {{ old('active', $voucher->active ? '1' : '0') == '0' ? 'selected' : '' }}>Nonaktif (Sembunyikan)</option>
                        </select>
                    </div>
                </div>

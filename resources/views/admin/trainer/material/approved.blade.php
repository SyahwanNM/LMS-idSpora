                    ...
                    @forelse(($approvedEventModules ?? collect()) as $event)
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                <div style="font-weight: 600; color: #334155;">
                                    {{ $eventDeadline ? $eventDeadline->format('d M Y H:i') : 'Belum ditentukan' }}</div>
                                <div style="font-size: 0.72rem; color: {{ $eventLate ? '#b91c1c' : '#64748b' }};">
                                    {{ $eventLate ? 'Melewati deadline' : 'Tanpa deadline' }}</div>
                            </td>
                            <td class="text-end">

        ...
        <div class="row g-4">
            <div class="col-xl-9">
                ...
                <div class="publish-tabs">
                    <button type="button" class="publish-tab-btn custom-tab-btn {{ $tab === 'items' ? 'active' : '' }}"
                        data-target="items-pane">
                        Acara / Kursus
                    </button>

                    <button type="button" class="publish-tab-btn custom-tab-btn {{ $tab === 'history' ? 'active' : '' }}"
                            ...
                            <table class="cert-table">
                                ...
                                <tbody>
                                    @forelse($pendingItems as $item)
                                                                    ...
                                                                    <tr class="cert-row" data-title="{{ strtolower($title) }}" data-status="ready">
                                                                        <td>
                                                                            <div class="program-cell">
                                                                                <div class="program-icon {{ $context === 'course' ? 'green' : '' }}">
                                                                                    <i
                                                                                        class="bi {{ $context === 'course' ? 'bi-mortarboard' : 'bi-calendar-event' }}"></i>
                                                                                </div>
                                                                        ...
                                                                        <td>
                                                                            <span
                                                                                class="type-badge">{{ strtoupper($context === 'course' ? 'Kursus' : 'Acara') }}</span>
                                                                        </td>
                                            ...
                                            'id' => $item['id'],
                                                                                    ...
                                                                                    style="background: #e2e8f0; color: #334155; min-width: auto; width: 34px; padding: 0;"
                            ...
                            <table class="cert-table">
                                ...
                                <tbody>
                                    @forelse($certificates as $certificate)
                                                                    ...
                                                                    <tr class="cert-row" data-title="{{ strtolower($programTitle) }}" data-status="done">
                                                                        <td>
                                                                            <div class="program-cell">
                                                                                <div class="program-icon {{ $isCourse ? 'green' : '' }}">
                                                                                    <i
                                                                                        class="bi {{ $isCourse ? 'bi-mortarboard' : 'bi-calendar-event' }}"></i>
                                                                                </div>

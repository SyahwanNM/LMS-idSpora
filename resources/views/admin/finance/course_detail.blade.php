...
@section('title', 'Detail Keuangan Course')
...
<div class="finance-wrapper" style="margin-top: 0;">
    ...
    <main class="finance-main">
                ...
                <div class="card-premium" style="background: linear-gradient(135deg, #1A1D1F 0%, #33383C 100%); color: #fff;">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-white-50 mb-0">Rincian Penjualan & Analisis Kursus</p>
                        </div>
                        <div class="col-md-4 text-md-end mt-3 mt-md-0">
                            <div class="stat-mini-label text-white-50">Laba Bersih Estimasi</div>
                            <div class="stat-mini-value text-white" style="font-size: 2rem;">Rp {{ number_format($totalIncome - $commissions, 0, ',', '.') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-6">
                <div class="card-premium text-center">
                    <div class="stat-mini-label">Total Penjualan (Gross)</div>
        ...
        <!-- Transaction List -->
        <h5 class="fw-bold mb-3">Daftar Transaksi Siswa</h5>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">Belum ada transaksi untuk course ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

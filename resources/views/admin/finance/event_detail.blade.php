...
<div class="finance-wrapper" style="margin-top: 0;">
    ...
    <main class="finance-main">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <a href="{{ route('admin.finance.events') }}" class="btn-back mb-0">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm" aria-labelledby="exportDropdown">
                    <li><a class="dropdown-item py-2 fw-semibold" href="{{ route('admin.finance.events.export', ['id' => $event->id, 'format' => 'pdf']) }}"><i class="bi bi-file-earmark-pdf text-danger me-2"></i> Ekspor PDF</a></li>
                    <li><a class="dropdown-item py-2 fw-semibold" href="{{ route('admin.finance.events.export', ['id' => $event->id, 'format' => 'excel']) }}"><i class="bi bi-file-earmark-spreadsheet text-success me-2"></i> Ekspor Excel (CSV)</a></li>
                </ul>
            </div>
        </div>

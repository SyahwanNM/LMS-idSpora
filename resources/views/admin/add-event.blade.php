...
<body>
    <div class="box-manage">
        <div class="box-title-add">
            <h3>Daftar Event</h3>
            <div>
                <input type="search" placeholder="Cari Event...">
            ...
            <button class="add-button" data-bs-toggle="modal" data-bs-target="#addEventModal">
            ...
            <table class="table-daftar table">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #E4E4E6;" scope="col">Lokasi</th>
                        <th style="background-color: #E4E4E6;" scope="col">Harga</th>
                        <th style="background-color: #E4E4E6;" scope="col">Pembicara</th>
                        <th style="background-color: #E4E4E6;" scope="col">Kelengkapan <br> Dokumen</th>
                ...
                <tbody>
                    <tr>
                        <td>Workshop Ui</td>
                        <td>14/08/2025</td>
                        <td>Ko+Lab Lt 4 FIT</td>
                        <td>Rp.15.000</td>
                        <td>Stephanie</td>
                        <td><button class="add-dokumen" data-bs-toggle="modal" data-bs-target="#uploadOperasionalModal"> 80%</button> </td>
                        <td>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#0A3EB6" class="bi bi-eye-fill" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#viewEventModal">
                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#EABE0C" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    <tr>
                        ...
                        <td>Rp.15.000</td>
                        <td>Stephanie</td>
                        <td><button class="add-dokumen" data-bs-toggle="modal" data-bs-target="#uploadOperasionalModal"> Lengkapi Dokumen</button> </td>
                        <td>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#0A3EB6" class="bi bi-eye-fill" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#viewEventModal">
                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7" />
        ...
        <div class="modal-add-event modal fade" id="addEventModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="scroll-add-event-box">
                    <div class="content-event modal-content">
                        ...
                        <div class="modal-body">
                            <form action="">
                                <div class="mb-3">
                                    <label for="gambar-event" class="form-label">Gambar event</label>
                                    <input type="file" class="form-control" id="gambar">
                                </div>
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama Event</label>
                                    <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Event">
                                </div>
                                <div class="mb-3">
                                    <div class="mb-3">
                                        <label for="deskripsi" class="form-label">Deskripsi Event</label>
                                        <input type="textarea" class="form-control" id="deskripsi" placeholder="Masukkan Deskripsi Event">
                                    </div>
                                    <div class="mb-3">
                                        <label for="tanggal" class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" id="tanggal" placeholder="Masukkan No Telp">
                                    </div>
                                    <div class="mb-3">
                                        <label for="waktu-mulai" class="form-label">Waktu Mulai</label>
                                        <input type="time" id="masuk1" name="masuk">
                                        <span class="separator">s/d</span>
                                        <input type="time" id="masuk2" name="keluar">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="textarea" class="form-control" id="benefit" placeholder="Masukkan Benefit">
                                    </div>
                                    <label for="maps" class="form-label">Maps Lokasi (Jika Offline)</label>
                                    <input type="text" class="form-control" id="maps" placeholder="Masukkan Link Lokasi">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.010714354917!2d110.366987774756!3d-7.824750777500901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5797a99a5fcb%3A0x1f8e3c51e5085cdd!2sUniversitas%20Gadjah%20Mada!5e0!3m2!1sid!2sid!4v1690800000000!5m2!1sid!2sid"
                                        width="100%"
                                        height="300"
                                        style="border:0;"
                                        allowfullscreen=""
                                ...
                                <div class="mb-3">
                                    <label for="zoom" class="form-label">Link Zoom (jika online)</label>
                                    <input type="text" class="form-control" id="zoom">
                                </div>
                                <div class="mb-3">
                                    <div class="mb-3">
                                        <label for="terms" class="form-label">Terms & Condition</label>
                                        <input type="textarea" class="form-control" id="terms" placeholder="Masukkan Terms & Condition">
                                    </div>
                                    <div class="mb-3">
                                        <label for="terms" class="form-label">Schedule</label>
                                        <table class="table-daftar-acara table">
                                            <thead>
                                                <tr>
                                                    <th style="background-color: #E4E4E6;" scope="col">Waktu</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Kegiatan</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Deskripsi</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div class="mb-3">
                                        <label for="terms" class="form-label">Pengeluaran</label>
                                        <table class="table-daftar-acara table">
                                            <thead>
                                                <tr>
                                                    <th style="background-color: #E4E4E6;" scope="col">Barang</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Kuantitas</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Harga Satuan</th>
                                                    <th style="background-color: #E4E4E6;" scope="col">Harga Total</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                        ...
                                        <button class="add-schedule">Tambah Pengeluaran</button>
                                    </div>
                            </form>
                        </div>
                        <div class="modal-footer">

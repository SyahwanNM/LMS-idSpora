                        ...
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                @if($event->image)
                                    <div class="mt-2 border rounded p-2 bg-light text-center">
                                        <img src="{{ $event->image_url }}" alt="Current Image" class="img-thumbnail rounded"
                                            style="max-width:260px;height:160px;object-fit:cover;"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="manage_action" id="manage_action" class="form-select" required>
                                    <option value="" disabled {{ $currentManage ? '' : 'selected' }}>Choice Event</option>
                                ...
                                <div class="form-text">Manage: operational/ongoing event. Create: new event from scratch.</div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="form-text">If Yes, this event will appear in the Reseller Commission Product.</div>
                            </div>
                            ...
                            <div id="lombaSettingsContainer" class="p-3 border rounded mb-3 bg-light" style="{{ old('jenis', $event->jenis) === 'Lomba' ? '' : 'display: none;' }}">
                                ...
                                @php
                                    $defaultStageCount = (int) old('lomba_stage_count', $event->lomba_stage_count ?? 2);
                                ...
                                <div class="row g-2">
                                    ...
                                    <div id="stage2FieldsContainer" class="row g-2 w-100 {{ $defaultStageCount === 2 ? '' : 'd-none' }}">
                                     ...
                                     <div class="col-md-6 mb-2" id="max_team_members_wrapper" style="{{ in_array(old('lomba_kategori', $event->lomba_kategori ?? 'individual'), ['team', 'both']) ? '' : 'display: none;' }}">
                                         ...
                                         <input type="text" name="max_team_members" id="max_team_members" class="form-control form-control-sm" placeholder="Contoh: 2-5, 2-3 atau 5" value="{{ old('max_team_members', $event->max_team_members ?? 5) }}">
                                     </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Format tampilan: Day, DD Month YYYY</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 {{ trim($defaultPlaceName) !== '' ? '' : 'd-none' }}" id="placeNameGroup">
                                <label for="place_name" class="form-label fw-semibold">Place Name <span class="text-danger" id="placeNameRequiredStar" style="display:none">*</span></label>
                                ...
                                <div class="form-text">Appears after clicking "Deteksi" for offline/hybrid.</div>
                            </div>
                            <div class="mb-3" id="mapsGroup">
                                <label for="maps" class="form-label fw-semibold">Maps Location (Offline/Hybrid) <span class="text-danger" id="mapsRequiredStar" style="display:none">*</span></label>
                                <div class="input-group">
                                        ...
                                        <tbody>
                                            ...
                                            @if(is_array($existingExpenses) && count($existingExpenses))
                                                @foreach($existingExpenses as $i => $row)
                                                    <tr>
                                                        <td><input type="text" class="form-control form-control-sm"
                                                                name="expenses[{{ $i }}][item]" placeholder="Nama barang"
                                                                value="{{ $row['item'] ?? '' }}"></td>
                                                        <td><input type="number" class="form-control form-control-sm"
                                                                name="expenses[{{ $i }}][quantity]" data-expense-qty min="0"
                                                                step="1" value="{{ $row['quantity'] ?? 0 }}"></td>
                                                        <td><input type="number" class="form-control form-control-sm"
                                                                name="expenses[{{ $i }}][unit_price]" data-expense-unit min="0"
                                                                step="1" value="{{ $row['unit_price'] ?? 0 }}"></td>
                                                        <td><input type="number" class="form-control form-control-sm"
                                                                name="expenses[{{ $i }}][total]" data-expense-total readonly
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const updateStage2Visibility = () => {
                ...
                const stage2RelatedInputs = [
                    ...
                    document.getElementById('price_stage2_edit'),
                    document.getElementById('price_stage2_display_edit'),
                ].filter(Boolean);

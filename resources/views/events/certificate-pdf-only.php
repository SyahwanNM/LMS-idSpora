...
<div class="certificate-page {{ $template }}">
    ...
    <div class="cert-inner">
        ...
        <div class="content" style="margin-top:10px;">
            ...
            <p style="font-size:11pt;line-height:1.4;color:#1e293b;margin-top:7px;">has successfully completed the program</p>
            <h2 style="font-size:18pt;color:#1e1b4b;margin:6px 0;font-family:'Georgia',serif;">"{{ $event->title }}"</h2>
            <p style="font-size:9pt;color:#64748b;">Issued on {{ $issuedAt->format('d F Y') }} by idSpora Team</p>
        </div>
    @elseif($template == 'template_2')
        ...
        <div class="content-wrap">
            ...
            <p style="font-size:13pt;color:#64748b;font-style:italic;margin-bottom:3px;">This is to certify that</p>
            <div class="recipient-name">{{ strtoupper($user->name) }}</div>
            <p style="font-size:11pt;color:#1e293b;margin-top:7px;">has successfully completed the program</p>
            <h2 style="font-size:18pt;color:#1e1b4b;margin:6px 0;">"{{ $event->title }}"</h2>
            <p style="font-size:9pt;color:#64748b;">Issued on {{ $issuedAt->format('d F Y') }} by idSpora Team</p>
        </div>
    @else
        <div class="header-bg">
            ...
            <h1>Certificate</h1>
            <p style="color:#fbbf24;font-weight:bold;margin:0;font-size:11pt;">PROFESSIONAL RECOGNITION</p>
        </div>
        <div class="main-content">
            <p style="font-size:12pt;color:#64748b;margin:0;">This certificate is proudly presented to</p>
            <div class="recipient-name">{{ strtoupper($user->name) }}</div>
            ...
            <h2 style="font-size:20pt;color:#1e1b4b;margin:6px 0;font-weight:800;">"{{ $event->title }}"</h2>
            <p style="font-size:9pt;color:#64748b;">Issued by IdSPora Authority on {{ $event->event_date?->format('d F Y') }}</p>
        </div>
    @endif
    ...
    <div class="cert-footer">
        <div style="float:right;">
            @forelse($signaturesBase64 as $sig)
                <div class="sig-box">
                    <img src="{{ $sig }}" style="height:50px;width:auto;display:block;margin:0 auto;">
    ...
    @if($template == 'template_1') </div> @endif

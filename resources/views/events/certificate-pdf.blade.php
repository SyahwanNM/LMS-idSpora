...
@if(!isset($is_preview) || !$is_preview)@page{size:A4 landscape;margin:0;}*{box-sizing:border-box;-webkit-print-color-adjust:exact;}html,body{margin:0;padding:0;width:297mm;@if($template != 'template_4')height:210mm;overflow:hidden;@endif background:white;font-family:'Helvetica','Arial',sans-serif;}@endif
        ...
        @if(isset($is_preview) && $is_preview)
            ...
            .template_1 h1 { font-size: 34pt !important; }
            .template_1 .recipient-name { font-size: 38pt !important; font-family: 'Great Vibes', cursive !important; }
        ...
        @else
            <div class="header" style="{{ ($template == 'template_1' || $template == 'template_2') ? 'padding: 40px 10px 0 10px; text-align: center;' : '' }}">
                @if($template == 'template_1')
                    ...
                    <h1 style="margin-top: 10px; font-size: 38pt; font-family: 'Georgia', serif; color: #1e1b4b;">Certificate</h1>
                ...
                @elseif($template == 'template_2')
                    <div class="logo-row">
                        <div class="logo-container">
                            ...
                            @endphp
                            @if(isset($is_preview) && $is_preview)
                                <img src="{{ $mainLogoUrl }}" class="logo-item" style="height: 50px;">
                            @elseif(file_exists($mainLogoPath))
